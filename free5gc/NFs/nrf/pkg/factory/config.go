...
type Configuration struct {
	...
	Fabric          *FabricInfo   `yaml:"fabric,omitempty" valid:"optional"`
}
...
func (c *Configuration) validate() (bool, error) {
	...
	// ////////////////////////////
	if c.Fabric != nil {
		if _, err := c.Fabric.validate(); err != nil {
			return false, err
		}
	}
	// ///////////////////////
...
type FabricInfo struct {
	...
	ChainCodeURL   string `yaml:"chaincodeUrl,omitempty" valid:"url,optional"`
	OAuthDelegated bool   `yaml:"oauthDelegated" valid:"type(bool),optional"`
}
func (f *FabricInfo) validate() (bool, error) {
	if f.Enabled && f.ChainCodeURL == "" {
		return false, errors.New("fabric is enabled but chaincodeUrl is not provided")
	}
...
// /////////////////////////////////
func (c *Config) IsFabricEnabled() bool {
	c.RLock()
	defer c.RUnlock()
	if c.Configuration != nil && c.Configuration.Fabric != nil {
		return c.Configuration.Fabric.Enabled
	}
	return false
}

// GetFabricChainCodeURL returns the Fabric chaincode URL
func (c *Config) GetFabricChainCodeURL() string {
	c.RLock()
	defer c.RUnlock()
	if c.Configuration != nil && c.Configuration.Fabric != nil {
		return c.Configuration.Fabric.ChainCodeURL
	}
	return ""
}

// IsFabricOAuthDelegated returns whether OAuth is delegated to Fabric
func (c *Config) IsFabricOAuthDelegated() bool {
	c.RLock()
	defer c.RUnlock()
	if c.Configuration != nil && c.Configuration.Fabric != nil {
		return c.Configuration.Fabric.OAuthDelegated
	}
	return false
}

// GetFabricInfo returns the complete Fabric configuration
func (c *Config) GetFabricInfo() *FabricInfo {
	c.RLock()
	defer c.RUnlock()
	if c.Configuration != nil {
		return c.Configuration.Fabric
	}
	return nil
}
